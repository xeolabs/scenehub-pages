    ...
    function postLoadObject(assetId, object) {
        ...
        if (object.appearance) {
            ...
            if (appearance.texture) {
                ...
                if (layers) {
                    for (var i = 0, len = layers.length; i < len; i++) {
                        layers[i].src = cfg.assetPath + "/object/" + assetId + "/" + layers[i].src;
                    }
                }
            }
        }
        if (object.sound) {
            object.sound.src = cfg.assetPath + "/object/" + assetId + "/" + object.sound.src;
        }
        if (object.objects) {
            var objects = object.objects;
            for (var i = 0, len = objects.length; i < len; i++) {
                postLoadObject(assetId, objects[i]);
            }
        }
    }
...
SceneHubAPI.configure({ assetPath: "http://xeolabs.github.com/scenehub/assets" });