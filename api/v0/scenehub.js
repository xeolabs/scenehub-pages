 ...
 * clash with internally generated IDs, which are numbers.
 */
var SceneHub_Map = function (items, _baseId) {
...
/**
 * Default loader, which will load asset of type "foo" and ID "bar" from ./assets/foo/bar.json
 * @private
 */
SceneHubAPI._defaultLoader = function (assetType, assetId, ok, error) {
    var jsonFile = new XMLHttpRequest();
    jsonFile.overrideMimeType("application/json");
    jsonFile.open("GET", SceneHubAPI._cfg.assetPath + "/" + assetType + "/" + assetId.replace(/\./g, "/") + ".json", true);
 ...
 */
SceneHubAPI._cfg = {
    assetLoader:SceneHubAPI._defaultLoader,
    assetPath:"assets/",
    dataStore:null
};

/**
 * Configuration for each {@link SceneHubAPI.SceneHub} subsequently created with {@link #createClient}.
 * @param params
 * @param {Function} [params.assetLoader]
 * @param {Function} [params.assetPath]
 * @param {Function} [params.dataStore]
 */
SceneHubAPI.configure = function (params) {
    if (params.assetLoader) {
        SceneHubAPI._cfg.assetLoader = params.assetLoader;
    }
    if (params.assetPath) {
        SceneHubAPI._cfg.assetPath = params.assetPath;
    }
    if (params.dataStore) {
        SceneHubAPI._cfg.dataStore = params.dataStore;
    }
};
 ...
 * @private
 */
SceneHubAPI._isArray = function (testObject) {
    return testObject && !(testObject.propertyIsEnumerable('length'))
        && typeof testObject === 'object' && typeof testObject.length === 'number';
};
 ...
 * @param parentObj
 */
SceneHubAPI._extend = function (childObj, parentObj) {
    var tmpObj = function () {
    };
...
/** Add properties of o to o2, overwriting them on o2 if already there
 */
SceneHubAPI._apply = function (o, o2) {
    for (var name in o) {
        if (o.hasOwnProperty(name)) {
            o2[name] = o[name];
        }
 ...
 * @private
 */
SceneHubAPI._applyIf = function (o, o2) {
    for (var name in o) {
        if (o.hasOwnProperty(name)) {
            if (o2[name] == undefined || o2[name] == null) {
                o2[name] = o[name];
...
SceneHubAPI._math.MAX_DOUBLE = 10000000;
SceneHubAPI._math.MIN_DOUBLE = -10000000;


/**
 * Arbitrarily-aligned 3D boundary
 * @param verts
 * @constructor
 */
SceneHubAPI._math.ArbitraryBox3 = function (verts) {
    this.verts = verts;
};

SceneHubAPI._math.ArbitraryBox3.prototype.setVerts = function (verts) {
    var p;
...
//SceneHubAPI._math.ArbitraryBox3.prototype.scale = function (x, y, z) {
//    var p;
...
//};
//
//SceneHubAPI._math.ArbitraryBox3.prototype.translate = function (x, y, z) {
//    var p;
//    for (var i = 0, len = this.verts.length; i < len; i++) {
//        p = this.verts[i];
//        p[0] += x;
...
SceneHubAPI._math.ArbitraryBox3.prototype.transform = function (m) {
    this.verts = SceneHubAPI._math.transformPoints4(m, this.verts); // TODO: inefficient for GC?
    return this;
};

SceneHubAPI._math.ArbitraryBox3.fromAxisBox = function (b) {
    return new SceneHubAPI._math.ArbitraryBox3([
        // v0-v1-v2-v3 front
        [b.xmin, b.ymax, b.zmax,1],
        [b.xmin, b.ymax, b.zmax,1],
        [b.xmin, b.ymin, b.zmax,1],
        [b.xmax, b.ymin, b.zmax,1],
        // v0-v3-v4-v5 right
        [b.xmax, b.ymax, b.zmax,1],
        [b.xmax, b.ymin, b.zmax,1],
        [b.xmax, b.ymin, b.zmin,1],
        [b.xmax, b.ymax, b.zmin,1],
        // v0-v5-v6-v1 top
        [b.xmax, b.ymax, b.zmax,1],
        [b.xmax, b.ymax, b.zmin,1],
        [b.xmin, b.ymax, b.zmin,1],
        [b.xmin, b.ymax, b.zmax,1],
        // v1-v6-v7-v2 left
        [b.xmin, b.ymax, b.zmax,1],
        [b.xmin, b.ymax, b.zmin,1],
        [b.xmin, b.ymin, b.zmin,1],
        [b.xmin, b.ymin, b.zmax,1],
        // v7-v4-v3-v2 bottom
        [b.xmin, b.ymin, b.zmin,1],
        [b.xmax, b.ymin, b.zmin,1],
...
SceneHubAPI._math.AxisBox3 = function (b) {
    b = b || {};
    this.xmin = b.xmin || 0;
    this.ymin = b.ymin || 0;
    this.zmin = b.zmin || 0;
...
SceneHubAPI._math.AxisBox3.prototype.invert = function () {
    this.xmin = SceneHubAPI._math.MAX_DOUBLE;
    this.ymin = SceneHubAPI._math.MAX_DOUBLE;
    this.zmin = SceneHubAPI._math.MAX_DOUBLE;
    this.xmax = SceneHubAPI._math.MIN_DOUBLE;
    this.ymax = SceneHubAPI._math.MIN_DOUBLE;
    this.zmax = SceneHubAPI._math.MIN_DOUBLE;
    return this;
};

SceneHubAPI._math.AxisBox3.prototype.expandByVerts = function (verts) {
    for (var i = 0, len = verts.length; i < len; i++) {
        p = verts[i];
...
SceneHubAPI._math.AxisBox3.prototype.expandAxisBox = function (b) {
...
SceneHubAPI._math.transformPoint3 = function (m, p) {
    return [
...
SceneHubAPI._math.transformPoint4 = function (m, v) {
    return [
...
SceneHubAPI._math.transformPoints3 = function (m, points) {
    var result = new Array(points.length);
    var len = points.length;
    for (var i = 0; i < len; i++) {
        result[i] = SceneHubAPI._math.transformPoint3(m, points[i]);
    }
    return result;
};

SceneHubAPI._math.transformPoints4 = function (m, points) {
    var result = new Array(points.length);
    var len = points.length;
    for (var i = 0; i < len; i++) {
        result[i] = SceneHubAPI._math.transformPoint4(m, points[i]);
    }
    return result;
};
 ...
 *
 */
SceneHubAPI._math.clamp = function (u, min, max) {
 ...
 *
 */
SceneHubAPI._math.divVec3 = function (u, v) {
    return [u[0] / v[0], u[1] / v[1], u[2] / v[2]];
};
 ...
 *
 */
SceneHubAPI._math.negateVector4 = function (v) {
 ...
 *
 */
SceneHubAPI._math.addVec4 = function (u, v) {
    return [u[0] + v[0], u[1] + v[1], u[2] + v[2], u[3] + v[3]];
};
 ...
 *
 */
SceneHubAPI._math.addVec4s = function (v, s) {
 ...
 *
 */
SceneHubAPI._math.addScalarVec4 = function (s, v) {
    return SceneHubAPI._math.addVec4s(v, s)
};

/**
 *
 */
SceneHubAPI._math.addVec3 = function (u, v) {
    return [u[0] + v[0], u[1] + v[1], u[2] + v[2]];
};
 ...
 *
 */
SceneHubAPI._math.addVec3s = function (v, s) {
 ...
 *
 */
SceneHubAPI._math.subVec4 = function (u, v) {
    return [u[0] - v[0], u[1] - v[1], u[2] - v[2], u[3] - v[3]];
};
 ...
 *
 */
SceneHubAPI._math.subVec3 = function (u, v) {
    return [u[0] - v[0], u[1] - v[1], u[2] - v[2]];
};
 ...
 *
 */
SceneHubAPI._math.lerpVec3 = function (t, t1, t2, p1, p2) {
    var f = (t - t1) / (t2 - t1);
    return  [
        p1[0] + (f * (p2[0] - p1[0])),
        p1[1] + (f * (p2[1] - p1[1])),
 ...
 *
 */
SceneHubAPI._math.lerpVec2 = function (t, t1, t2, p1, p2) {
    var f = (t - t1) / (t2 - t1);
    return  [
        p1[0] + (f * (p2[0] - p1[0])),
        p1[1] + (f * (p2[1] - p1[1]))
 ...
 *
 */
SceneHubAPI._math.negateVector3 = function (v) {
    return [-v[0], -v[1], -v[2]];
};
 ...
 *
 */
SceneHubAPI._math.subVec2 = function (u, v) {
    return [u[0] - v[0], u[1] - v[1]];
};
 ...
 *
 */
SceneHubAPI._math.subVec4Scalar = function (v, s) {
    return [v[0] - s, v[1] - s, v[2] - s, v[3] - s];
};
 ...
 *
 */
SceneHubAPI._math.subScalarVec4 = function (v, s) {
 ...
 *
 */
SceneHubAPI._math.mulVec4 = function (u, v) {
    return [u[0] * v[0], u[1] * v[1], u[2] * v[2], u[3] * v[3]];
};
 ...
 *
 */
SceneHubAPI._math.mulVec4Scalar = function (v, s) {
    return [v[0] * s, v[1] * s, v[2] * s, v[3] * s];
};
 ...
 *
 */
SceneHubAPI._math.mulVec3Scalar = function (v, s) {
    return [v[0] * s, v[1] * s, v[2] * s];
};
 ...
 *
 */
SceneHubAPI._math.mulVec2Scalar = function (v, s) {
    return [v[0] * s, v[1] * s];
};
 ...
 *
 */
SceneHubAPI._math.divVec4 = function (u, v) {
    return [u[0] / v[0], u[1] / v[1], u[2] / v[2], u[3] / v[3]];
};
 ...
 *
 */
SceneHubAPI._math.divScalarVec3 = function (s, v) {
 ...
 *
 */
SceneHubAPI._math.divVec3s = function (v, s) {
    return [v[0] / s, v[1] / s, v[2] / s];
};
 ...
 *
 */
SceneHubAPI._math.divVec4s = function (v, s) {
    return [v[0] / s, v[1] / s, v[2] / s, v[3] / s];
};
 ...
 *
 */
SceneHubAPI._math.divScalarVec4 = function (s, v) {
    return [s / v[0], s / v[1], s / v[2], s / v[3]];
};
 ...
 *
 */
SceneHubAPI._math.dotVector4 = function (u, v) {
    return (u[0] * v[0] + u[1] * v[1] + u[2] * v[2] + u[3] * v[3]);
};
 ...
 *
 */
SceneHubAPI._math.cross3Vec4 = function (u, v) {
    return [u[1] * v[2] - u[2] * v[1], u[2] * v[0] - u[0] * v[2], u[0] * v[1] - u[1] * v[0], 0.0];
};


SceneHubAPI._math.cross3Vec3 = function (u, v) {
 ...
 *
 */
SceneHubAPI._math.sqLenVec4 = function (v) {
    return SceneHubAPI._math.dotVector4(v, v);
};
 ...
 *
 */
SceneHubAPI._math.lenVec4 = function (v) {
    return Math.sqrt(SceneHubAPI._math.sqLenVec4(v));
};
 ...
 *
 */
SceneHubAPI._math.dotVector3 = function (u, v) {
    return (u[0] * v[0] + u[1] * v[1] + u[2] * v[2]);
};
 ...
 *
 */
SceneHubAPI._math.dotVector2 = function (u, v) {
    return (u[0] * v[0] + u[1] * v[1]);
};
 ...
 *
 */
SceneHubAPI._math.sqLenVec3 = function (v) {
    return SceneHubAPI._math.dotVector3(v, v);
};
 ...
 *
 */
SceneHubAPI._math.sqLenVec2 = function (v) {
    return SceneHubAPI._math.dotVector2(v, v);
};
 ...
 *
 */
SceneHubAPI._math.lenVec3 = function (v) {
    return Math.sqrt(SceneHubAPI._math.sqLenVec3(v));
};
 ...
 *
 */
SceneHubAPI._math.lenVec2 = function (v) {
    return Math.sqrt(SceneHubAPI._math.sqLenVec2(v));
};
 ...
 *
 */
SceneHubAPI._math.rcpVec3 = function (v) {
    return SceneHubAPI._math.divScalarVec3(1.0, v);
};

/**
 *
 */
SceneHubAPI._math.vec3ObjToArray = function (v) {
    return [v.x, v.y, v.z];
};
 ...
 *
 */
SceneHubAPI._math.vec3ArrayToObj = function (v) {
 ...
 *
 */
SceneHubAPI._math.normalizeVec4 = function (v) {
    var f = 1.0 / SceneHubAPI._math.lenVec4(v);
    return SceneHubAPI._math.mulVec4Scalar(v, f);
};
 ...
 *
 */
SceneHubAPI._math.normalizeVec3 = function (v) {
    var f = 1.0 / SceneHubAPI._math.lenVec3(v);
    return SceneHubAPI._math.mulVec3Scalar(v, f);
};

SceneHubAPI._math.normalizeVec2 = function (v) {
    var f = 1.0 / SceneHubAPI._math.lenVec2(v);
    return SceneHubAPI._math.mulVec2Scalar(v, f);
};
 ...
 *
 */
SceneHubAPI._math.mat4 = function () {
    return new Array(16);
};
 ...
 *
 */
SceneHubAPI._math.dupMat4 = function (m) {
    return m.slice(0, 16);
};
 ...
 *
 */
SceneHubAPI._math.getCellMat4 = function (m, row, col) {
    return m[row + col * 4];
};
 ...
 *
 */
SceneHubAPI._math.setCellMat4 = function (m, row, col, s) {
    m[row + col * 4] = s;
};
 ...
 *
 */
SceneHubAPI._math.getRowMat4 = function (m, r) {
 ...
 *
 */
SceneHubAPI._math.setRowMat4 = function (m, r, v) {
    m[r + 0] = v[0];
    m[r + 4] = v[1];
    m[r + 8] = v[2];
    m[r + 12] = v[3];
 ...
 *
 */
SceneHubAPI._math.setRowMat4c = function (m, r, x, y, z, w) {
    SceneHubAPI._math.setRowMat4(m, r, [x, y, z, w]);
};
 ...
 *
 */
SceneHubAPI._math.setRowMat4s = function (m, r, s) {
    SceneHubAPI._math.setRowMat4c(m, r, s, s, s, s);
};
 ...
 *
 */
SceneHubAPI._math.getColMat4 = function (m, c) {
    var i = c * 4;
 ...
 *
 */
SceneHubAPI._math.setColMat4v = function (m, c, v) {
    var i = c * 4;
    m[i + 0] = v[0];
    m[i + 1] = v[1];
    m[i + 2] = v[2];
 ...
 *
 */
SceneHubAPI._math.setColMat4c = function (m, c, x, y, z, w) {
    SceneHubAPI._math.setColMat4v(m, c, [x, y, z, w]);
};
 ...
 *
 */
SceneHubAPI._math.setColMat4Scalar = function (m, c, s) {
    SceneHubAPI._math.setColMat4c(m, c, s, s, s, s);
};
 ...
 *
 */
SceneHubAPI._math.mat4To3 = function (m) {
    return [
        m[0], m[1], m[2],
        m[4], m[5], m[6],
        m[8], m[9], m[10]
 ...
 *
 */
SceneHubAPI._math.m4s = function (s) {
    return [
        s, s, s, s,
        s, s, s, s,
        s, s, s, s,
 ...
 *
 */
SceneHubAPI._math.setMat4ToZeroes = function () {
    return SceneHubAPI._math.m4s(0.0);
};
 ...
 *
 */
SceneHubAPI._math.setMat4ToOnes = function () {
    return SceneHubAPI._math.m4s(1.0);
};

/**
 *
 */
SceneHubAPI._math.diagonalMat4v = function (v) {
    return [
        v[0], 0.0, 0.0, 0.0,
        0.0, v[1], 0.0, 0.0,
        0.0, 0.0, v[2], 0.0,
 ...
 *
 */
SceneHubAPI._math.diagonalMat4c = function (x, y, z, w) {
    return SceneHubAPI._math.diagonalMat4v([x, y, z, w]);
};

/**
 *
 */
SceneHubAPI._math.diagonalMat4s = function (s) {
    return SceneHubAPI._math.diagonalMat4c(s, s, s, s);
};

/**
 *
 */
SceneHubAPI._math.identityMat4 = function () {
    return SceneHubAPI._math.diagonalMat4s(1.0);
};

/**
 *
 */
SceneHubAPI._math.isIdentityMat4 = function (m) {
    var i = 0;
    var j = 0;
    var s = 0.0;
    for (i = 0; i < 4; ++i) {
 ...
 *
 */
SceneHubAPI._math.negateMat4 = function (m) {
    var r = SceneHubAPI._math.mat4();
    for (var i = 0; i < 16; ++i) {
        r[i] = -m[i];
    }
    return r;
 ...
 *
 */
SceneHubAPI._math.addMat4 = function (a, b) {
    var r = SceneHubAPI._math.mat4();
    for (var i = 0; i < 16; ++i) {
        r[i] = a[i] + b[i];
    }
 ...
 *
 */
SceneHubAPI._math.addMat4Scalar = function (m, s) {
    var r = SceneHubAPI._math.mat4();
    for (var i = 0; i < 16; ++i) {
        r[i] = m[i] + s;
    }
 ...
 *
 */
SceneHubAPI._math.addScalarMat4 = function (s, m) {
    return SceneHubAPI._math.addMat4Scalar(m, s);
}

/**
 *
 */
SceneHubAPI._math.subMat4 = function (a, b) {
    var r = SceneHubAPI._math.mat4();
    for (var i = 0; i < 16; ++i) {
        r[i] = a[i] - b[i];
    }
 ...
 *
 */
SceneHubAPI._math.subMat4Scalar = function (m, s) {
    var r = SceneHubAPI._math.mat4();
    for (var i = 0; i < 16; ++i) {
        r[i] = m[i] - s;
    }
 ...
 *
 */
SceneHubAPI._math.subScalarMat4 = function (s, m) {
    var r = SceneHubAPI._math.mat4();
    for (var i = 0; i < 16; ++i) {
        r[i] = s - m[i];
    }
 ...
 * @private
 */
SceneHubAPI._math.mulMat4 = function (a, b, dest) {
    if (!dest) {
        dest = a;
    }
 ...
 *
 */
SceneHubAPI._math.mulMat4s = function (m, s) {
    var r = SceneHubAPI._math.mat4();
    for (var i = 0; i < 16; ++i) {
        r[i] = m[i] * s;
    }
 ...
 *
 */
SceneHubAPI._math.mulMat4v4 = function (m, v) {
    return [
        m[0] * v[0] + m[4] * v[1] + m[8] * v[2] + m[12] * v[3],
        m[1] * v[0] + m[5] * v[1] + m[9] * v[2] + m[13] * v[3],
        m[2] * v[0] + m[6] * v[1] + m[10] * v[2] + m[14] * v[3],
 ...
 *
 */
SceneHubAPI._math.transposeMat4 = function (m) {
    var r = SceneHubAPI._math.mat4();
    var i = 0;
    var j = 0;
    for (i = 0; i < 4; ++i) {
 ...
 *
 */
SceneHubAPI._math.determinantMat4 = function (m) {
    var f = SceneHubAPI._math.getCellMat4;
    return (
 ...
 *
 */
SceneHubAPI._math.inverseMat4 = function (m) {
    var m0 = m[ 0], m1 = m[ 1], m2 = m[ 2], m3 = m[ 3],
        m4 = m[ 4], m5 = m[ 5], m6 = m[ 6], m7 = m[ 7],
        m8 = m[ 8], m9 = m[ 9], m10 = m[10], m11 = m[11],
        m12 = m[12], m13 = m[13], m14 = m[14], m15 = m[15];

    var n = SceneHubAPI._math.identityMat4();
 ...
 *
 */
SceneHubAPI._math.traceMat4 = function (m) {
    return (m[0] + m[5] + m[10] + m[15]);
}
 ...
 *
 */
SceneHubAPI._math.translationMat4v = function (v) {
    var m = SceneHubAPI._math.identityMat4();
    m[12] = v[0];
    m[13] = v[1];
    m[14] = v[2];
    return m;
 ...
 *
 */
SceneHubAPI._math.translationMat4c = function (x, y, z) {
    return SceneHubAPI._math.translationMat4v([x, y, z]);
}

/**
 *
 */
SceneHubAPI._math.translationMat4s = function (s) {
    return SceneHubAPI._math.translationMat4c(s, s, s);
}

/**
 *
 */
SceneHubAPI._math.rotationMat4v = function (anglerad, axis) {
    var ax = SceneHubAPI._math.normalizeVec4([axis[0], axis[1], axis[2], 0.0]);
    var s = Math.sin(anglerad);
    var c = Math.cos(anglerad);
    var q = 1.0 - c;
 ...
 *   [m10 m11 m12]
 *   [m20 m21 m22]*/
SceneHubAPI._math.rotationEulerMat4v = function (x, y, z) {
 ...
 *
 */
SceneHubAPI._math.rotationMat4c = function (anglerad, x, y, z) {
    return SceneHubAPI._math.rotationMat4v(anglerad, [x, y, z]);
};

/**
 *
 */
SceneHubAPI._math.scalingMat4v = function (v) {
    var m = SceneHubAPI._math.identityMat4();
    m[0] = v[0];
    m[5] = v[1];
    m[10] = v[2];
 ...
 *
 */
SceneHubAPI._math.scalingMat4c = function (x, y, z) {
    return SceneHubAPI._math.scalingMat4v([x, y, z]);
}

/**
 *
 */
SceneHubAPI._math.scalingMat4s = function (s) {
    return SceneHubAPI._math.scalingMat4c(s, s, s);
}

/**
 *
 */
SceneHubAPI._math.lookAtMat4v = function (pos, target, up) {
    var pos4 = [pos[0], pos[1], pos[2], 0.0];
    var target4 = [target[0], target[1], target[2], 0.0];
    var up4 = [up[0], up[1], up[2], 0.0];

    var v = SceneHubAPI._math.normalizeVec4(SceneHubAPI._math.subVec4(target4, pos4));
    var u = SceneHubAPI._math.normalizeVec4(up4);
    var s = SceneHubAPI._math.normalizeVec4(SceneHubAPI._math.cross3Vec4(v, u));

    u = SceneHubAPI._math.normalizeVec4(SceneHubAPI._math.cross3Vec4(s, v));
    ...
    m = SceneHubAPI._math.mulMat4(m, SceneHubAPI._math.translationMat4v(SceneHubAPI._math.negateVector4(pos4)));
 ...
 *
 */
SceneHubAPI._math.lookAtMat4c = function (posx, posy, posz, targetx, targety, targetz, upx, upy, upz) {
    return SceneHubAPI._math.lookAtMat4v([posx, posy, posz], [targetx, targety, targetz], [upx, upy, upz]);
}

/**
 *
 */
SceneHubAPI._math.orthoMat4v = function (omin, omax) {
    var omin4 = [omin[0], omin[1], omin[2], 0.0];
    var omax4 = [omax[0], omax[1], omax[2], 0.0];
    var vsum = SceneHubAPI._math.addVec4(omax4, omin4);
    var vdif = SceneHubAPI._math.subVec4(omax4, omin4);
 ...
 *
 */
SceneHubAPI._math.orthoMat4c = function (left, right, bottom, top, znear, zfar) {
    return SceneHubAPI._math.orthoMat4v([left, bottom, znear], [right, top, zfar]);
}

/**
 *
 */
SceneHubAPI._math.frustumMat4v = function (fmin, fmax) {
    var fmin4 = [fmin[0], fmin[1], fmin[2], 0.0];
    var fmax4 = [fmax[0], fmax[1], fmax[2], 0.0];
    var vsum = SceneHubAPI._math.addVec4(fmax4, fmin4);
    var vdif = SceneHubAPI._math.subVec4(fmax4, fmin4);
    var t = 2.0 * fmin4[2];
 ...
 *
 */
SceneHubAPI._math.frustumMatrix4 = function (left, right, bottom, top, znear, zfar) {
    return SceneHubAPI._math.frustumMat4v([left, bottom, znear], [right, top, zfar]);
}

/**
 *
 */
SceneHubAPI._math.perspectiveMatrix4 = function (fovyrad, aspectratio, znear, zfar) {
    ...
    return SceneHubAPI._math.frustumMat4v(pmin, pmax);
};
 ...
 *
 */
SceneHubAPI._math.transformVector3 = function (m, v) {
    return [
 ...
 *
 */
SceneHubAPI._math.projectVec4 = function (v) {
    var f = 1.0 / v[3];
    return [v[0] * f, v[1] * f, v[2] * f, 1.0];
}
 ...
 *
 */
SceneHubAPI._math.Plane3 = function (normal, offset, normalize) {
    this.normal = [0.0, 0.0, 1.0 ];
    this.offset = 0.0;
    if (normal && offset) {
 ...
 *
 */
SceneHubAPI._math.identityQuaternion = function () {
    return [ 0.0, 0.0, 0.0, 1.0 ];
};
 ...
 *
 */
SceneHubAPI._math.angleAxisQuaternion = function (axis, radians) {
    // var angleRad = (degrees / 180.0) * Math.PI;
 ...
 *
 */
SceneHubAPI._math.mulQuaternions = function (p, q) {
    return [
 ...
 *
 */
SceneHubAPI._math.newMat4FromQuaternion = function (q) {
    var tx = 2.0 * q[0];
    var ty = 2.0 * q[1];
    var tz = 2.0 * q[2];
    var twx = tx * q[3];
    ...
    var tzz = tz * q[2];
    var m = SceneHubAPI._math.identityMat4();
    SceneHubAPI._math.setCellMat4(m, 0, 0, 1.0 - (tyy + tzz));
    SceneHubAPI._math.setCellMat4(m, 0, 1, txy - twz);
    SceneHubAPI._math.setCellMat4(m, 0, 2, txz + twy);
    SceneHubAPI._math.setCellMat4(m, 1, 0, txy + twz);
    SceneHubAPI._math.setCellMat4(m, 1, 1, 1.0 - (txx + tzz));
    SceneHubAPI._math.setCellMat4(m, 1, 2, tyz - twx);
    SceneHubAPI._math.setCellMat4(m, 2, 0, txz - twy);
    SceneHubAPI._math.setCellMat4(m, 2, 1, tyz + twx);
    SceneHubAPI._math.setCellMat4(m, 2, 2, 1.0 - (txx + tyy));
    return m;
};
 ...
 *
 */
SceneHubAPI._math.normalizeQuaternion = function (q) {
    var len = SceneHubAPI._math.lenVec3([q[0], q[1], q[2]]);
    return [ q[0] / len, q[1] / len, q[2] / len, q[3] / len ];
};
 ...
 *
 */
SceneHubAPI._math.conjugateQuaternion = function (q) {
    return[-q[0], -q[1], -q[2], q[3]];
};
 ...
 *
 */
SceneHubAPI._math.angleAxisFromQuaternion = function (q) {
    q = SceneHubAPI._math.normalizeQuaternion(q);
 ...
 *
 */
SceneHubAPI._math.getBoundaryCenter = function (boundary) {
    return [(boundary.xmax + boundary.xmin ) * 0.5,
 ...
 *
 */
SceneHubAPI._math.getBoundaryDiag = function (boundary) {
    return Math.abs(
        SceneHubAPI._math.lenVec3(
            SceneHubAPI._math.subVec3(
                [boundary.xmax, boundary.ymax, boundary.zmax],
                [boundary.xmin, boundary.ymin, boundary.zmin])));
};/**
 * @class Base class for an SceneHub Component.
 * @constructor
 */
SceneHubAPI.Component = function () {

};


SceneHubAPI.Component.prototype = {

    _init:function () {

        this._handleMap = new SceneHub_Map(); // Subscription handle pool
    ...
    /**
     *
     * Listen for data changes at a particular location. This is the primary way to read data from SceneHubAPI.
     *
     ...
     *
     * @param topic Publication topic
     * @param callback Called when a fresh publication is available on the topic
     * @return {String} Handle to the subscription, which may be used to unsubscribe with {@link SceneHubAPI.Component#unsubscribe}.
     */
    ...
    /**
     * Unsubscribes from a publication on this Component that was previously made with {@link SceneHubAPI.Component#subscribe}.
    ...
    /**
     * Listens for exactly one event of the specified event type, and then stops listening. This is equivalent to
     * calling “on”, and then calling “off” inside the callback function.
     * @param topic
     * @param callback
     */
    once:function (topic, callback) {
        var self = this;
        var handle = this.on(topic,
            function (pub) {
                self.off(handle);
                callback(pub);
            });
 ...
 * A SceneHub client.
 */
var SceneHub = function (cfg) {

        this._init();

        this._cfg = SceneHubAPI._apply(cfg || {}, SceneHubAPI._cfg);
        this._idMap = new SceneHub_Map();

        /**
         * Scenes created by this client
         * @type {{String: SceneHubAPI.SceneHub}}
         */
        this.scenes = {};
    };

SceneHubAPI._extend(SceneHub, SceneHubAPI.Component);

/**
 * Creates a new scene.
 * Publishes the scene to "scenes.<scene ID>" and returns it via optional callback.
 * Returns it synchronously if it's not being loaded from an asset.
 * @param params
 * @param ok
 * @return {*}
 */
SceneHub.prototype.createScene = function (params, ok) {
    ...
    if (sceneId) {
        if (this.scenes[sceneId]) {
            throw "scene with this ID already in client: " + sceneId;
        }
    } else {
        sceneId = this._idMap.addItem({});
        params = SceneHubAPI._apply({ id:sceneId }, params);
    }

    if (params.useScene) {
        // Reusing a scene from asset library
        var self = this;
        this._cfg.assetLoader("scene", params.useScene,
            function (json) {
                var scene = self._createScene(SceneHubAPI._apply(params, json));
                if (ok) {
                    ok(scene);
                }
            });

    } else if (params.dataRef) {
        var dataRef = params.dataRef;
        if (!dataRef.user) {
            throw "param expected: dataRef.user";
        }
        if (!dataRef.id) {
            throw "param expected: dataRef.id";
        }
        if (!this._dataStore) {
            throw "no dataStore configured";
        }
        //this._cfg.dataStore.load(dataRef, this._toJSON(), ok, error);

    } else {
        var scene = this._createScene(params);
        if (ok) {
            ok(scene);
        }
        return scene;
...
SceneHub.prototype._createScene = function (params) {
    var scene = new SceneHubAPI.Scene(SceneHubAPI._apply(params, this._cfg)); // Override configs
    this.scenes[params.id] = scene;
    this._publish("scenes." + params.id, scene); // Publish new scene
    return scene;
};
/**
 * A SceneHub scene.
 */
SceneHubAPI.Scene = function (cfg) {
    ...
    /**
     * Scene content roots. These consist of a root for each "space", to which nodes will be attached
     * by the various objects within this model.
     * They are expected to have specific IDs, and only the "world" root is mandatory.
     * @type {SceneJS.Node}
     */
    var nodes;
    ...
    if (cfg.nodes) {
        ...
        // Pre-made set of content root nodes
        if (!cfg.nodes["world"]) {
            throw "'world' node mandatory in nodes config";
        }
        nodes = cfg.nodes;
        ...
        if (cfg.scene) {
            // Pre-made user-supplied scene graph
            // Expect user to start it
            this._scenejsScene = cfg.scene;

        } else {

            // Default internal scene graph
            ...
            if (!canvasId) {
                ...
                // TODO: automatic flow layout for multiple canvases
                ...
                // GitHub "fork me" ribbon unless suppressed
                var ribbon = "";
                if (cfg.forkMeRibbon !== false) {
                    ribbon = '<a href="https://github.com/scenehub"><img style="position: absolute; top: 0; left: 0; border: 0;" src="https://s3.amazonaws.com/github/ribbons/forkme_left_green_007200.png" alt="Fork me on GitHub"></a>';
                }
                newdiv.innerHTML = '<canvas id="' + canvasId + '" style="width: 100%; height: 100%; margin: 0; padding: 0;"></canvas>' + ribbon;
                body.appendChild(newdiv);
            }

            this._scenejsScene = SceneJS.createScene(SceneHubAPI.Scene._getDefaultScene(this.id, canvasId, cfg.lights));

            var self = this;

            this._scenejsScene.start({
                idleFunc:function () {
                    self._publish("tick");
                }
            });
        ...
        var world = this._scenejsScene.getNode("world");
        if (!world) {
            throw "scene must have a node with ID 'world'";
        }

        nodes = {
            // Nodes under the mandatory World-space root translate and rotate as we move the camera around.
            // This is where we'd put things like landscapes, models etc.
            "world":world,
            // Nodes under the optional View-space root remain stationary and aligned with the view frustum as we move
            // the camera around. This is where we'd put a heads-up display, for example.
            "view":this._scenejsScene.getNode("view"),
            // Nodes under the optional Sky-space root will rotate but won't translate as the camera moves.
            // This is where we'd put a sky box.
            "sky":this._scenejsScene.getNode("sky")
        };
    }

    /**
     * Object factory
     * @type {SceneHubAPI.Scene._ObjectFactory}
     * @private
     *
     *
     */
    this._objectFactory = new SceneHubAPI.Scene._ObjectFactory(this, cfg.assetLoader, postLoadObject, nodes);

    function postLoadObject(assetId, object) {
        assetId = assetId.replace(/\./g, "/");
        var idx = assetId.lastIndexOf("/");
        _postLoadObject((idx > -1) ? assetId.substr(0, idx) : "", object);
    }

    function _postLoadObject(assetDir, object) {
        if (object.appearance) {
            var appearance = object.appearance;
            if (appearance.texture) {
                var layers = appearance.texture.layers;
                if (layers) {
                    for (var i = 0, len = layers.length; i < len; i++) {
                        layers[i].src = cfg.assetPath + "/object/" + assetDir + "/" + layers[i].src;
                    }
                }
            }
        }
        if (object.sound) {
            object.sound.src = cfg.assetPath + "/object/" + assetDir + "/" + object.sound.src;
        }
        if (object.objects) {
            var objects = object.objects;
            for (var i = 0, len = objects.length; i < len; i++) {
                _postLoadObject(assetDir, objects[i]);
            }
        }
    }
     ...
     * @private
     */
    this._dataStore = cfg.dataStore;

    /**
     * ID map of objects
     * @type {{String: SceneHubAPI.Object}}
     */
    this.objects = {};

    /**
     * ID map of root Objects
     * @type {{String: SceneHubAPI.Object}}
     */
    this.rootObjects = {};
    ...
    /**
     * Count of objects currently loading
     * @type {Number}
     */
    this.numObjectsLoading = 0;

    // Find camera nodes
    var cameraNode = this._scenejsScene.getNode("camera");
    if (!cameraNode) {
        throw "scene node not found: 'camera'";
    }

    var lookatNode = this._scenejsScene.getNode("lookat");
    if (!lookatNode) {
        throw "scene node not found: 'lookat'";
    }

    /**
     * The camera
     * @type {SceneHubAPI.Camera}
     */
    this.camera = new SceneHubAPI.Camera(this, cameraNode, lookatNode, cfg.camera || {});

    /**
     * Scene node library
     */
    var libNode = nodes["world"].addNode({
        type:"library"
    });

    /**
     * Appearances library
     * @type SceneHubAPI.AssetLibrary
     */
    this.appearances = new SceneHubAPI.AssetLibrary({
        model:this,
        type:"appearance",
        libNode:libNode,
        loader:cfg.assetLoader,
        postLoad:function (assetId, json) { // Make paths to texture files
            assetId = assetId.replace(/\./g, "/");
            var idx = assetId.lastIndexOf("/");
            if (idx > -1) {
                assetId = assetId.substr(0, idx);
            } else {
                assetId = "";
            }
            if (json.texture) {
                var layers = json.texture.layers;
                if (layers) {
                    for (var i = 0, len = layers.length; i < len; i++) {
                        layers[i].src = cfg.assetPath + "/appearance/" + assetId + "/" + layers[i].src;
                    }
                }
            }
        },
        factory:SceneHubAPI.Appearance
    });
     ...
     * @type SceneHubAPI.AssetLibrary
     */
    this.shaders = new SceneHubAPI.AssetLibrary({
        type:"shader",
        model:this,
        libNode:libNode,
        loader:cfg.assetLoader,
        factory:SceneHubAPI.Shader
    });
     ...
     * @type SceneHubAPI.AssetLibrary
     */
    this.geometries = new SceneHubAPI.AssetLibrary({
        type:"geometry",
        model:this,
        libNode:libNode,
        loader:cfg.assetLoader,
        factory:SceneHubAPI.Geometry
    });
     ...
     * @type SceneHubAPI.AssetLibrary
     */
    this.morphs = new SceneHubAPI.AssetLibrary({
        type:"morph",
        model:this,
        libNode:libNode,
        loader:cfg.assetLoader,
        factory:SceneHubAPI.Morph
    });
     ...
     * @type SceneHubAPI.AssetLibrary
     */
    this.behaviours = new SceneHubAPI.AssetLibrary({
        type:"behaviour",
        model:this,
        loader:cfg.assetLoader,
        factory:SceneHubAPI.Behaviour
    });

    /**
     * Sound library
     * @type SceneHubAPI.Sounds
     */
    this.sounds = new SceneHubAPI.AssetLibrary({
        type:"sound",
        model:this,
        loader:cfg.assetLoader,
        postLoad:function (assetId, sound) { // Make path to audio file
            assetId = assetId.replace(/\./g, "/");
            var idx = assetId.lastIndexOf("/");
            if (idx > -1) {
                assetId = assetId.substr(0, idx);
            ...
            sound.src = cfg.assetPath + "/sound/" + assetId + "/" + sound.src;
        },
        factory:SceneHubAPI.Sound
    });

    // Create inline object graph
    if (cfg.objects) {
        for (var i = 0, len = cfg.objects.length; i < len; i++) {
            this.createObject(cfg.objects[i]);
        }
    }
};

SceneHubAPI._extend(SceneHubAPI.Scene, SceneHubAPI.Component);

/**
 * Creates a root object.
 *
 * 1. publishes "objectLoading"
 * 2. creates object
 * 3. fires callback with new object
 * 4. publishes "objectCreated"
 *
 * @param cfg Object configs
 * @param cfg.id Object ID, unique among all objects in this model
 * @param cfg.space
 * @param ok Returns new object
 */
SceneHubAPI.Scene.prototype.createObject = function (cfg, ok) {
    this._objectFactory.create(null, null, cfg, ok);
};

/**
 * Saves this scene.
 * The scene is saved as JSON optimised for persistence, so if the scene was built up from
 * calls to {@link SceneHubAPI.Scene#createObject} etc., it it not likely to resemble the structure
 * of the JSONs you provided to those methods.
 * @param key User key
 * @param ok Success callback
 * @param error Error callback
 */
SceneHubAPI.Scene.prototype.save = function (key, ok, error) {
    if (!key) {
        throw "param expected: key";
    }
    if (!this._dataStore) {
        throw "no dataStore configured";
    }
    this._dataStore.save(key, this.id, this._toJSON(), ok, error);
};


SceneHubAPI.Scene.prototype._toJSON = function () {
    var json = {
        foo:"foo",
        objects:[]
    };
    for (var objectId in this.rootObjects) {
        if (this.rootObjects.hasOwnProperty(objectId)) {
            json.objects.push(this.objects[objectId]._toJSON());
        }
    }
    return json;
};

SceneHubAPI.Scene.prototype.destroy = function () {

};

/**
 * Returns a default scene graph
 * @return {Object}
 * @private
 */
SceneHubAPI.Scene._getDefaultScene = function (sceneId, canvasId, lights) {
    return {
        "id":sceneId,
        "canvasId":canvasId,
        nodes:[
...
/** A camera in a {@link SceneHubAPI.Scene}
 *
 * @param cfg
 * @constructor
 */
SceneHubAPI.Camera = function (model, cameraNode, lookatNode, cfg) {

    this._init();

    /** Owner Model
     * @type {SceneHubAPI.Scene}
     */
    this.model = model;

    this._camera = cameraNode;
    this._lookat = lookatNode;

    this.set(cfg);
};

SceneHubAPI._extend(SceneHubAPI.Camera, SceneHubAPI.Component);


/**
 * Set camera attributes and publishes whatever was updated
 * @param params
 */
SceneHubAPI.Camera.prototype.set = function (params) {
    params = params || {};
    if (params.eye) {
        this._lookat.setEye(params.eye);
        this._publish("eye", this._lookat.getEye());
    }
    if (params.look) {
        this._lookat.setLook(params.look);
        this._publish("look", this._lookat.getLook());
    }
    if (params.up) {
        this._lookat.setUp(params.up);
        this._publish("up", this._lookat.getUp());
    }
    if (params.optics) {
        this._camera.setOptics(params.optics);
        this._publish("optics", this._camera.getOptics());
    }
};
/**
 * Factory to create objects within a given model
 *
 * @private
 */
SceneHubAPI.Scene._ObjectFactory = function (model, assetLoader, postLoadObject, nodes) {

    var idMap = new SceneHub_Map();

    /**
     * Creates an object
     * @param parent Parent object
     * @param node Scene node to build on
     * @param cfg Configs for new object
     * @param ok Callback to return new object
     */
    this.create = function (parent, node, cfg, ok) {
        ...
        if (cfg.id) {
            if (model.objects[cfg.id]) {
                throw "object already exists: " + cfg.id;
            }
            id = cfg.id;
        } else {
            id = idMap.addItem({});
        ...
        if (!node) {
            ...
            node = nodes[space];
            if (!node) {
                throw "node not found: " + space;
            }
        }

        model._publish("objectLoading", {
            objectId:id,
            numObjectsLoading:model.numObjectsLoading
        });

        var self = this;

        if (cfg.useObject) {
            assetLoader("object", cfg.useObject,
                function (object) {
                    postLoadObject(cfg.useObject, object);
                    self._createObject(parent, node, SceneHubAPI._apply(cfg, object), id, ok);
                });
        } else {
            this._createObject(parent, node, cfg, id, ok);
        }
    };
    ...
    this._createObject = function(parent, node, cfg, id, ok) {
        ...
        new SceneHubAPI.Object(model, parent, node, cfg, this,

            function (object) { // ok

                model.objects[id] = object;
                model.numObjects++;
                ...
                model.numObjectsLoading--;

                // Publish notification of object creation
                model._publish("objectCreated", {
                    object: object,
                    numObjectsLoading:model.numObjectsLoading
                });

                // Publish the object
                model._publish("objects." + id, object);
            });
    };
    ...
    function countObjects(object) {
        ...
        for (var objectId in object.objects) {
            if (object.objects.hasOwnProperty(objectId)) {
                count += countObjects(object.objects[objectId]);
            }
        }
        return count;
    }
    ...
    this.destroy = function (object) {
        ...
        if (!model.objects[objectId]) {
            // this._log("object not found: " + objectId);
            return;
        }

        delete model.objects[objectId];
        delete model.rootObjects[objectId];

        idMap.removeItem(objectId);

        model.numObjects--;
        model._publish("objectDestroyed", {
            objectId:objectId
        });

        // Publish the null object
        model._publish("objects." + object.id, null);
    };
};
/**
 * An object contained within an {@link SceneHubAPI.Scene}
 * @param model
 * @param parent
 * @param node
 * @param cfg
 ...
 * @constructor
 */
SceneHubAPI.Object = function (model, parent, node, cfg, factory, ok) {
    ...
    /**
     * Object ID, unique within {@link SceneHubAPI.Scene}
     * @type {String}
     */
    this.id = cfg.id;
    ...
    /**
     * Parent object
     * @type {SceneHubAPI.Object}
     */
    this.parent = parent;

    /**
     * Level in object hierarchy - 0 for root
     * @type {Number}
     */
    ...
    // Buffers asset references and/or attributes for deferred scene fragment creation
    // Core IDs will create nodes that share cores
    // Attributes create nodes with new cores
    var assets = {
        ...
        soundAttr:null // Sourced either inline or via asset
    };
    ...
    function buildObject() {
        self._buildNodes(cfg, node, assets,
            function () {
                var objects = cfg.objects;
                if (objects) {
                    for (var i = 0, len = objects.length; i < len; i++) {
                        self.createObject(objects[i]);
                    }
                }
                if (ok) {
                    ok(self);
    ...
    // Queue asset loads
    if (cfg.useAppearance) {
        loads.push(
            function () {
                self.model.appearances.getAsset(cfg.useAppearance,
                    function (appearance) {
                        if (appearance.material) {
                            assets.materialCoreId = appearance.material.getCoreId();
                        }
                        if (appearance.texture) {
                            assets.textureCoreId = appearance.texture.getCoreId();
                        }
                        self._appearanceId = cfg.useAppearance;
                        if (--numLoads == 0) {
                            buildObject();
                        }
                    });
        ...
        numLoads++;
    } else if (cfg.appearance) {
        assets.materialAttr = cfg.appearance.material;
        assets.textureAttr = cfg.appearance.texture;
    }

    if (cfg.useShader) {
        loads.push(
            function () {
                self.model.shaders.getAsset(cfg.useShader,
                    function (shader) {
                        assets.shaderCoreId = shader.node.getCoreId();
                        self._shaderId = cfg.useShader;
                        if (--numLoads == 0) {
                            buildObject();
                        }
                    });
        ...
        assets.shaderAttr = cfg.shader;
    }

    if (cfg.shaderParams) {
        assets.shaderParams = cfg.shaderParams;
    }
    ...
    if (cfg.useMorph) {
        loads.push(
            function () {
                self.model.geometries.getAsset(cfg.useMorph,
                    function (morph) {
                        assets.morphCoreId = morph.node.getCoreId();
                        self._morphId = cfg.useMorph;
                        if (--numLoads == 0) {
                            buildObject();
                        }
                    });
    ...
    if (cfg.useGeometry) {
        loads.push(
            function () {
                self.model.geometries.getAsset(cfg.useGeometry,
                    function (geometry) {
                        assets.geometryCoreId = geometry.node.getCoreId();
                        self._geometryId = cfg.useGeometry;
                        if (--numLoads == 0) {
                            buildObject();
                        }
                    });
        ...
        assets.geometryAttr = cfg.geometry;
    }
    ...
    if (cfg.useSound) {
        loads.push(
            function () {
                self.model.sounds.getAsset(cfg.useSound,
                    function (sound) {
                        assets.soundAttr = sound.attr;
                        self._soundId = cfg.useSound;
                        if (--numLoads == 0) {
                            buildObject();
                        }
                    });
        ...
        assets.soundAttr = cfg.sound;
    }

    if (cfg.events) {
        assets.events = cfg.events;
    }

    // Bind behaviours to topics
    if (cfg.behaviours) {
        var behaviours = cfg.behaviours;
        var funcs;
        for (var behaviourId in behaviours) {
            if (behaviours.hasOwnProperty(behaviourId)) {
                funcs = behaviours[behaviourId];
                if (SceneHubAPI._isArray(funcs)) { // Multiple behaviours
                    for (var i = 0, len = funcs.length; i < len; i++) {
                        this.on(behaviourId, funcs[i].fn);
                    }
                } else {
                    this.on(behaviourId, funcs.fn);
                }
            }
        }
    }
    ...
    if (loads.length == 0) {
        ...
        while (loads.length > 0) { // Do asset loads then build nodes
            (loads.pop())();
        }
    }
};

SceneHubAPI._extend(SceneHubAPI.Object, SceneHubAPI.Component);


/**
 * Builds SceneJS fragment
 */
SceneHubAPI.Object.prototype._buildNodes = function (cfg, node, assets, ok) {

    // Flag         
    this.flags = node.addNode({
        type:"flags",
        flags:SceneHubAPI._apply(cfg.flags || {}, {
            enabled:true
        })
    });
    node = this.flags;

    this._rootNode = this.flags;

    // Transformation     
    if (cfg.translate) {
        this.translate = node.addNode({
            type:"translate",
            x:cfg.translate.x,
            y:cfg.translate.y,
            z:cfg.translate.z
    ...
    if (cfg.rotate) {
        this.rotate = node.addNode({
            type:"rotate",
            x:cfg.rotate.x,
            y:cfg.rotate.y,
            z:cfg.rotate.z,
            angle:cfg.rotate.angle
        });
        node = this.rotate;
    }
    if (cfg.scale) {
        this.scale = node.addNode({
            type:"scale",
            x:cfg.scale.x,
            y:cfg.scale.y,
            z:cfg.scale.z
    ...
    // Appearance     
    if (assets.materialCoreId) {
        node = this.material = node.addNode({
            type:"material",
            coreId:assets.materialCoreId
        });
    } else if (assets.materialAttr) {
        assets.materialAttr.type = "material";
        node = this.material = node.addNode(assets.materialAttr);
    }
    if (assets.textureCoreId) {
        node = this.texture = node = node.addNode({
            type:"texture",
            coreId:assets.textureCoreId
        });
    } else if (assets.textureAttr) {
        assets.textureAttr.type = "texture";
        node = this.texture = node.addNode(assets.textureAttr);
    }

    // Shader     
//    if (assets.shaderCoreId) {
//        node = this.shader = node.addNode({
//            type:"shader",
//            coreId:assets.shaderCoreId
//        });
//    } else if (assets.shaderAttr) {
//        assets.shaderAttr.type = "shader";
//        node = this.shader = node.addNode(assets.shaderAttr);
//    }

    // Shader params     
    if (assets.shaderParams) {
        node = this.shaderParams = node.addNode({
            type:"shaderParams",
            params:cfg.shaderParams || {}
        });
    }

//    if (assets.events) {
//        var events = assets.events;
//        node = node.addNode({  // Work around bug in SceneJS 3.0 where listeners can't be bound to geometry nodes
//            type:"node"
//        });
//        var self = this;
//        node.bind("rendered",
...
//                if (events.worldPos) {
//                    self._publish("worldPos", params.getWorldPos());
//                }
//                if (events.viewPos) {
//                    self._publish("viewPos", params.getViewPos());
//                }
//                if (events.canvasPos) {
//                    self._publish("canvasPos", params.getCanvasPos());
//                }
//            });
//    }

    // Morph   
    if (assets.morphCoreId || assets.morphAttr) {
        if (assets.morphCoreId) {
            this.morph = node.addNode({
                type:"morphGeometry",
                coreId:assets.morphCoreId
            });
        } else if (assets.morphAttr) {
            assets.morphAttr.type = "morphGeometry";
            this.morph = node.addNode(assets.morphAttr);
        }
        node = this.morph;
    }

    // Geometry     
    if (assets.geometryCoreId || assets.geometryAttr) {
        if (assets.geometryCoreId) {
            this.geometry = node.addNode({
                type:"geometry",
                coreId:assets.geometryCoreId
            });
        } else if (assets.geometryAttr) {
            assets.geometryAttr.type = "geometry";
            this.geometry = node.addNode(assets.geometryAttr);
        }
        node = this.geometry;
        var boundary = node.getBoundary();

        this._modelBoundary = new SceneHubAPI._math.AxisBox3(boundary);
        this._worldBoundary = null; // Needs building        
    }

    // Sound     
    if (assets.soundAttr) { // soundAttr is provided via asset or inline

        // HACK: in SceneJS 3.0 a geometry must exists in order to create a display list node.
        // HACK: Geometry mesh data is specified in order to avoid dependency on plugins.
        if (!assets.geometryCoreId && !assets.geometryAttr) {
            node.addNode({
                type:"geometry",
                coreId:"__sound-location", // Helps state sorting
                primitive:"points",
                positions:[ 1, 1, 1 ],
                indices:[ 0 ]
            });
        ...
        // Bind a sound renderer to the geometry's position
        var soundRenderer = new SceneHubAPI._SoundRenderer(assets.soundAttr);
        this._soundRenderer = soundRenderer;

        // HACK: 'rendered' listeners don't work on geometry nodes in SceneJS 3.0
        // but we know we'll always have a flags node on leaf objects
        this.flags.addListener("rendered",
            function (event) {
                var params = event.params;
                var worldPos = params.getWorldPos([ 0, 0, 0 ]);
//                var viewPos = params.getViewPos([ 0, 0, 0 ]);
//                var canvasPos = params.getCanvasPos([ 0, 0, 0 ]);

                soundRenderer.set({ pos:worldPos });
            });

        // TODO: bind sound mute/play/stop to 'enabled' flag
    }

    /* Save leaf node for child Objects to graft onto
     */
    this._leafNode = node;
 ...
 * @param cfg
 * @param ok Callback which returns the new object
 */
SceneHubAPI.Object.prototype.createObject = function (cfg, ok) {
    this._factory.create(this, this._leafNode, cfg, ok);
};
 ...
 * @param params
 */
SceneHubAPI.Object.prototype.set = function (params) {

    var boundaryDirty = false;

    if (params.flags && this.flags) {
        this.flags.setFlags(params.flags);

        // "enabled" flag mutes sound when false
        if (this._soundRenderer) {
            this._soundRenderer.set({
                mute:!this.flags.getEnabled()
            });
        }
    }
    if (params.translate && this.translate) {
        this.translate.setXYZ(params.translate);
        boundaryDirty = true;
    }
    if (params.scale && this.scale) {
        this.scale.setXYZ(params.scale);
        boundaryDirty = true;
    }
    if (params.rotate && this.rotate) {
        this.rotate.set(params.rotate);
        boundaryDirty = true;
    }
    if (params.shaderParams && this.shaderParams) {
        this.shaderParams.setParams(params.shaderParams);
    }
    if (params.morphFactor && this.morph) {
        this.morph.setFactor(params.morphFactor);
    }
    if (params.sound && this._soundRenderer) {
        this._soundRenderer.set(params.sound);
    }
    if (boundaryDirty) {
...
/**
 * Flags rebuild for World-space boundaries in object subtree
 * @private
 */
SceneHubAPI.Object.prototype._setBoundaryDirty = function () {
    this._worldBoundary = null;
    if (this.numObjects > 0) {
        for (var objectId in this.objects) {
            if (this.objects.hasOwnProperty(objectId)) {
                this.objects[objectId]._setBoundaryDirty();
            }
        }
    }
    this._publish("boundaryUpdated");
};

/**
 * Gets axis-aligned Model-space boundary
 */
SceneHubAPI.Object.prototype.getModelBoundary = function () {
    return this._modelBoundary;
};

/**
 * Gets axis-aligned World-space boundary
 */
SceneHubAPI.Object.prototype.getWorldBoundary = function () {
    if (!this._worldBoundary) {
        this._buildWorldBoundary(); // Lazy rebuild
    }
    return this._worldBoundary;
};

/**
 * Builds  World-space boundary
 * @private
 */
SceneHubAPI.Object.prototype._buildWorldBoundary = function () {
    if (!this._worldBoundary) {
        if (this._modelBoundary) {
            var arbBox = new SceneHubAPI._math.ArbitraryBox3.fromAxisBox(this._modelBoundary);
            var worldMatrix = this.getWorldMatrix();
            if (worldMatrix) {
                arbBox.transform(worldMatrix);
            }
            this._worldBoundary = new SceneHubAPI._math.AxisBox3().invert().expandByVerts(arbBox.verts);
        }
    }
};

/**
 * Gets lowest World-space matrix in scene fragment
 */
SceneHubAPI.Object.prototype.getWorldMatrix = function () {
    for (var object = this; !!object; object = object.parent) {
        if (object.scale) {
            return object.scale.getWorldMatrix();
        }
        else if (object.rotate) {
            return object.rotate.getWorldMatrix();
        }
        else if (object.translate) {
            return object.translate.getWorldMatrix();
        }
    }
    return SceneHubAPI._math.identityMat4();
};

/**
 * Called by child Object to notify of destruction
 * @private
 */
SceneHubAPI.Object.prototype._objectDestroyed = function (objectId) {
    delete this.objects[objectId];
    this.numObjects--;
};

/**
 * Destroys this object and sub-objects
 */
SceneHubAPI.Object.prototype.destroy = function () {
    ...
    if (this._appearanceId) {
        this.model.appearances.putAppearance(this._appearanceId);
    }

    if (this._morphId) {
        this.model.morphs.putMorph(this._morphId);
    }

    if (this._geometryId) {
        this.model.geometries.putGeometry(this._geometryId);
    }

    if (this._shaderId) {
        this.model.shaders.putShader(this._shaderId);
    }

    if (this._soundRenderer) {
        this._soundRenderer.destroy();
    }

    if (this.parent) {
        this.parent._objectDestroyed(this.id);
    }
...
/** A library of {@link SceneHubAPI.Geometry} assets.
 *
 * @param cfg
 * @constructor
 */
SceneHubAPI.AssetLibrary = function (cfg) {
    ...
    /**
     * The type of asset contained within this library
     * @type String
     */
    this.type = cfg.type;

    this._loader = cfg.loader;
    this._factory = cfg.factory;
    this._libNode = cfg.libNode;

    // Transform to apply to asset after it's loaded
    this._postLoad = cfg.postLoad;

    this.assets = {};
};

SceneHubAPI._extend(SceneHubAPI.AssetLibrary, SceneHubAPI.Component);

/**
 * Creates an asset in this library.
 *
 * The asset does not get a reference count, as it would if it were created by #getAsset, meaning that #putAsset
 * has no effect for assets created using this method.

 * @param {Object} cfg Asset configuration
 * @return {*} The asset
 */
SceneHubAPI.AssetLibrary.prototype.createAsset = function (cfg) {

    var id = cfg.id;
    if (!id) {
        throw "config expected: id";
    }

    if (this.assets[id]) {
        throw "asset already defined: " + id;
    }

    var asset = new this._factory(this._libNode, cfg);

    var self = this;

    asset.on("destroyed",
        function () {
            delete self.assets[id];
        });
...
/**
 * Gets an asset from this library, loading it first if a loader has been configured and the asset does not exist in the library.
 *
 * Assets that are loaded by this method get a reference count that is incremented by this method and
 * decremented by #putAsset, so that when the reference count is zero the asset is automatically destroyed.
 *
 * Assets created with #createAsset don't get a reference count and must be manually destroyed with the asset object's destroy method.
 *
 * @param {String} id Asset ID
 * @param {Function} ok Callback which returns the asset
 */
SceneHubAPI.AssetLibrary.prototype.getAsset = function (id, ok) {
    var asset = this.assets[id];
    if (asset) {
        (asset._useCount == undefined) ? asset._useCount = 1 : asset._useCount++;
        ok(asset);
    } else {
        var self = this;
        if (!this._loader) {
        ...
        this._loader(this.type, id,
            function (data) {
                if (self.assets[id]) {
                    ...
                    data.id = id;
                    if (self._postLoad) {
                        self._postLoad(id, data);
                    }
                    asset = self.createAsset(data);
                    (asset._useCount == undefined) ? asset._useCount = 1 : asset._useCount++;
                    ok(asset);
                }
            });
...
/**
 * Releases an asset that was got with #getAsset.
 * If the asset is released as many times as it was got with #getAsset, then it is automatically destroyed.
 * Has no effect on assets created with #createAsset, which do not get a reference count. Only use this method with
 * assets got with #getAsset.
 * @param id
 */
SceneHubAPI.AssetLibrary.prototype.putAsset = function (id) {
    var asset = this.assets[id];
    if (asset) {
        if (asset._useCount != undefined) {
            if (--asset._useCount == 0) {
                asset.destroy();
            }
        }
    }
};/**
 * An appearance asset within a {@link SceneHubAPI.Appearances} library.
 *
 * @param cfg Scene node configuration
 * @constructor
 */
SceneHubAPI.Appearance = function (libNode, cfg) {

    this._init();

    /** Unique appearance ID
     *
     * @type {*}
     */
    this.id = cfg.id;
    ...
    this.node = libNode.addNode({
        type:"node"
    });

    if (cfg.texture) {
        this.texture = this.node.addNode(
            SceneHubAPI._apply(cfg.texture, {
                type:"texture"
            }));
    }

    if (cfg.material) {
        this.material = this.node.addNode(
            SceneHubAPI._apply(cfg.material, {
                type:"material"
            }));
    }
};

SceneHubAPI._extend(SceneHubAPI.Appearance, SceneHubAPI.Component);

SceneHubAPI.Appearance.prototype.destroy = function () {
    this.node.destroy();
    this._publish("destroyed");
};
...
/**
 * A shader asset within a {@link SceneHubAPI.Shaders} library.
 *
 * @param cfg Scene node configuration
 * @constructor
 */
SceneHubAPI.Shader = function (libNode, cfg) {
    ...
    this.node = libNode.addNode(
        SceneHubAPI._apply(cfg, {
            type:"shader"
        }));
};

SceneHubAPI._extend(SceneHubAPI.Shader, SceneHubAPI.Component);

SceneHubAPI.Shader.prototype.destroy = function () {
    this.node.destroy();
    this._publish("destroyed");
};
...
/**
 * A geometry asset within a {@link SceneHubAPI.Geometries} library.
 *
 * @param libNode
 * @param cfg Scene node configuration
 * @constructor
 */
SceneHubAPI.Geometry = function (libNode, cfg) {
...
SceneHubAPI._extend(SceneHubAPI.Geometry, SceneHubAPI.Component);

SceneHubAPI.Geometry.prototype.destroy = function () {
    this.node.destroy();
    this._publish("destroyed");
};
...
/**
 * A geometry morph asset within a {@link SceneHubAPI.Morphs} library.
 *
 * @param libNode
 * @param cfg Scene node configuration
 * @constructor
 */
SceneHubAPI.Morph = function (libNode, cfg) {
...
SceneHubAPI._extend(SceneHubAPI.Morph, SceneHubAPI.Component);

SceneHubAPI.Morph.prototype.destroy = function () {
    this.node.destroy();
    this._publish("destroyed");
};
...
/**
 * A behaviour morph asset within a {@link SceneHubAPI.Behaviours} library.
 *
 * @param cfg Scene node configuration
 * @constructor
 */
SceneHubAPI.Behaviour = function (libNode, cfg) {
    ...
    /**
     * Behaviour function, called on scope of a target {@link SceneHubAPI.Object}
     * @type Function
     */
    this.fn = cfg.fn;
...
SceneHubAPI._extend(SceneHubAPI.Behaviour, SceneHubAPI.Component);
...
/**
 * A sound asset within a {@link SceneHubAPI.Geometries} library.
 *
 * @param libNode
 * @param cfg Scene node configuration
 * @constructor
 */
SceneHubAPI.Sound = function (libNode, cfg) {
    ...
    if (!cfg.src) {
        throw "sound asset attribute expected: src";
    }

    this.src = cfg.src;
};

SceneHubAPI._extend(SceneHubAPI.Sound, SceneHubAPI.Component);

SceneHubAPI.Sound.prototype.destroy = function () {
    this.node.destroy();
    this._publish("destroyed");
};/**
 * Renders a sound asset for an {@link SceneHubAPI.Object}
 *
 * @param cfg Configuration
 * @constructor
 * @private
 */
SceneHubAPI._SoundRenderer = function (cfg) {

    if (!cfg.src) {
        throw "soundRenderer asset attribute expected: src";
    }

    this._init();

    /**
     * SoundRenderer attributes
     * @type {*}
     */
    this.attr = cfg;
    ...
    var audioId = "__SceneHub._SoundRenderer." + SceneHubAPI._SoundRenderer._idMap.addItem();
    this._audioContainerId = audioId + ".container";

    var body = document.getElementsByTagName("body")[0];
    var newdiv = document.createElement('div');
    newdiv.id = this._audioContainerId;
    newdiv.innerHTML = '<audio id="' + audioId + '"  src=""></audio>';
    body.appendChild(newdiv);

    var audio = document.getElementById(audioId);

    this._audio = audio;
    this._supported = audio.canPlayType('audio/ogg;codecs="vorbis"') === "probably";

    if (!this._supported) {
        // this.log.warn('audio not supported');
        return;
    }
//
//    $("#player").bind('ended',
...
SceneHubAPI._extend(SceneHubAPI._SoundRenderer, SceneHubAPI.Component);


SceneHubAPI._SoundRenderer._idMap = new SceneHub_Map();


SceneHubAPI._SoundRenderer.prototype.set = function (params) {
    ...
    if (params.src) {
        this.src = params.src;
        this._audio.setAttribute("src", this.src);
    }
...
SceneHubAPI._SoundRenderer.prototype.destroy = function () {

    SceneHubAPI._SoundRenderer._idMap.removeItem(this._audioId);

    var body = document.getElementsByTagName("body")[0];
    body.removeChild(this._audioContainerId);

    //this._publish("destroyed");
};

SceneHubAPI.configure({
    assetPath:"http://scenehub.github.com/scenehub-assets/assets"
});